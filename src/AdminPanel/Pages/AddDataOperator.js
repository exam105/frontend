...
const DataOperatorUI = () => {
  ...
  const deleteOperator = () => {
    if (window.deleteId === "") {
      ...
      axios({
        method: "DELETE",
        url: `/superuser/operator/${window.deleteId}`,
      })
        .then((res) => {
          $(".updateButton").removeClass("d-flex");
          $(".updateButton").addClass("d-none");
  ...
  return (
    ...
    >
      <div className="row">
        <div className="col-md-4">
          <form className="py-4 rounded bg-white">
            ...
            <Button
              ...
              className="d-none updateButton mx-auto mt-5"
            >
              Update
            </Button>
            <Button
              ...
              className="mx-auto addButton d-flex mt-5"
            >
              Add
            </Button>
          </form>
        ...
        <div className="col-md-8">
          <div className="rounded bg-white">
            <h1 className="text-center m-0 shadow border py-4">
              All Operators
            </h1>
            <TableContainer
              className="pb-3"
                ...
                <TableBody>
                  {rows?.map((row, index) => (
                    <TableRow key={row.name}>
                      ...
                      <TableCell className="border" align="center">
                        <FcEditImage
                          onClick={() => setOperatorData(row.id)}
      ...
      {/*   Confirm Dialog Box   */}
      <ConfirmDialog
        delete_mcq_by_id={deleteOperator}
        ConfirmDialog={confirmDialogStatus}
        ConfirmDesc={confirmDialogDesc}

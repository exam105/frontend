...
function AdminAddmcqsComponent(props) {
  ...
  return (
    <section className="add_mcq_main pt-3">
                  ...
                  <div className="all_mcq_operations_button d-flex mx-auto justify-content-between w-100 ">
                    ...
                    <div>
                      ...
                      <button
                        type="button"
                        style={{ display: "none" }}
                        onClick={update_mcq_by_id}
                        className="border mt-2 mybutton update_mcq_button btn mybutton btn-info"
                      >
                        update
                      </button>
                      <Button
                        variant="contained"
                        onClick={add_mcq}
                        className="bg-info mybutton next_mcq_button"
                      >
                        Next
                      </Button>
                    </div>
      ...
      {/*   Confirm Dialog Box   */}
      <ConfirmDialog
        delete_mcq_by_id={delete_mcq_by_id}
